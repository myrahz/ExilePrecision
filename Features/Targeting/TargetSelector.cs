    ...
    public class TargetSelector
    {
        ...
        private void UpdateTargetSelection(Vector2 playerPos)
        {
            ...
            if (_currentTarget != null)
            {
                ...
                {
                    var distance = Vector2.Distance(playerPos, _currentTarget.GridPos);
        ...
        private void SelectNewTarget(Vector2 playerPos)
        {
            ...
            if (shouldSwitch)
            {
                ...
                EventBus.Instance.Publish(new TargetAcquiredEvent(
                    bestTarget,
                    Vector2.Distance(playerPos, bestTarget.GridPos),
                    bestTarget.GridPos,
                    weight));
        ...
        private float CalculateFinalWeight(Entity entity)
        {
            ...
            if (_settings.Targeting.Density.EnableClustering)
            {
                ...
                if (density != null)
                {
                    ...
                    {
                        var distanceFromCenter = Vector2.Distance(density.Center, entity.GridPos);
