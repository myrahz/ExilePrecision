...
using ExilePrecision.Routines.StormcallerIncendiary.Strategy;
...
namespace ExilePrecision.Routines.StormcallerIncendiary
{
    public class StormcallerIncendiaryRoutine : OrbWalkingRoutineBase
    {
        private readonly TargetSelector _targetSelector;
        private readonly SkillPriority _skillPriority;
        private readonly LineOfSight _lineOfSight;

        public StormcallerIncendiaryRoutine(GameController gameController)
            : base("Stormcaller Incendiary", gameController)
        {
