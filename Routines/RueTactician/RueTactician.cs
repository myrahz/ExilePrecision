...
using ExilePrecision.Routines.RueTactician.Strategy;
...
namespace ExilePrecision.Routines.RueTactician
{
    public class RueTactician : OrbWalkingRoutineBase
    {
        private readonly TargetSelector _targetSelector;
        private readonly SkillPriority _skillPriority;
        private readonly LineOfSight _lineOfSight;

        public RueTactician(GameController gameController)
            : base("RueTactician Incendiary", gameController)
        {
