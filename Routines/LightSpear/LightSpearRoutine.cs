...
using ExilePrecision.Routines.LightSpear.Strategy;
...
namespace ExilePrecision.Routines.LightSpear
{
    public class LightSpearRoutine : OrbWalkingRoutineBase
    {
        private readonly TargetSelector _targetSelector;
        private readonly SkillPriority _skillPriority;
        private readonly LineOfSight _lineOfSight;

        public LightSpearRoutine(GameController gameController)
            : base("LightSpear", gameController)
        {
