...
using ExilePrecision.Routines.WyvernDruidLeveling.Strategy;
...
namespace ExilePrecision.Routines.WyvernDruidLeveling
{
    public class WyvernDruidLeveling : OrbWalkingRoutineBase
    {
        ...
        public WyvernDruidLeveling(GameController gameController)
            : base("WyvernDruidLeveling", gameController)
        {
