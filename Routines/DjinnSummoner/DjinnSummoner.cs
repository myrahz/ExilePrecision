...
using ExilePrecision.Routines.DjinnSummoner.Strategy;
...
namespace ExilePrecision.Routines.DjinnSummoner
{
    public class DjinnSummoner : OrbWalkingRoutineBase
    {
        private readonly TargetSelector _targetSelector;
        private readonly SkillPriority _skillPriority;
        private readonly LineOfSight _lineOfSight;

        public DjinnSummoner(GameController gameController)
            : base("DjinnSummoner", gameController)
        {
