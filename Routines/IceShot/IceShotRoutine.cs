...
using ExilePrecision.Routines.IceShot.Strategy;
...
{
    public class IceShotRoutine : OrbWalkingRoutineBase
    {
        private readonly TargetSelector _targetSelector;
        private readonly SkillPriority _skillPriority;
        private readonly LineOfSight _lineOfSight;

        public IceShotRoutine(GameController gameController)
            : base("IceShot", gameController)
        {
