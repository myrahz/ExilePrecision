...
using ExilePrecision.Routines.InfusedSorc.Strategy;
...
namespace ExilePrecision.Routines.InfusedSorc
{
    public class InfusedSorc : OrbWalkingRoutineBase
    {
        private readonly TargetSelector _targetSelector;
        private readonly SkillPriority _skillPriority;
        private readonly LineOfSight _lineOfSight;

        public InfusedSorc(GameController gameController)
            : base("InfusedSorc", gameController)
        {
